<template>
    <Teleport to="body">
        <div v-if="visible" :class="[theme, 'x-modal-overlay']" @click="onClickMaskHandler" :style="overlayStyle">
            ...
            <div tabindex="11" ref="modalRef" class="x-modal-content" :style="modalContentStyle" @focus="focusHandler"
                @blur="blurHandler">
                <div :style="modalInnerBgStyle" @click.stop>
                    <div class="x-modal-inner-content" :style="innerContentStyle">
                        <div class="x-modal-ctrl" :style="ctrlStyle">
                            ...
                            <span v-if="showMove" class="x-modal-ctrl-btn x-modal-move-btn"
                                @mousedown="handleMoveMouseDown">
                                <svg width="15" height="15" viewBox="0 0 64 64" style="display: inline-block">
                                    <path
                                        d="M36.6,14.5H32h14.9L31.9,0L17.2,14.5h10.3v13.5H13.6v9h13.8v13.6h9.1V37h13.7v-9H36.6V14.5z M31.9,64l13.8-13.4H18.3L31.9,64L31.9,64z M0,32.5L13.6,46v-27L0,32.5L0,32.5z M50.3,19.1v27L64,32.5L50.3,19.1L50.3,19.1z">
                                    </path>
                                </svg>
                            </span>

                            <span v-if="showMinize" :style="{ display: modalState !== 'min' ? 'inline-block' : 'none' }"
                                class="x-modal-ctrl-btn x-modal-min-btn" @click="onClickMinHandler">
                                <span></span>
                            </span>
                ...
                <span v-if="showResize" class="x-modal-resize-btn" @mousedown.prevent="handleResizeMouseDown">
                    <svg width="24" height="24" viewBox="0 0 64 64">
                        <path
                            d="M28.2,32.1l3.8-3.8l-6.1-6.1l4.1-4.1H18v12.1l4.2-4.2L28.2,32.1z M14,2L9.8,6.2L3.7,0.1L0,3.9L6.1,10l-4,3.9H14V2z">
                        </path>
                    </svg>
                </span>
            </div>
