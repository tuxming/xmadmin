<template>
    <t-drawer class="skin-setting-drawer" v-model:visible="visible" :header="t('系统设置')" :footer="false" size="450px">
            ...
            <t-tab-panel value="theme" :label="t('主题')">
                <div class="setting-panel">
                    <div class="setting-item">
                        ...
                        <t-switch :model-value="themeStore.theme === 'dark'"
                    ...
                    <div class="setting-item">
                        ...
                        <div class="color-picker-wrap">
                            <span v-for="c in colors" :key="c" class="color-block" :style="{ background: c }"
                                @click="themeStore.setPrimaryColor(c)">
                                <t-icon v-if="themeStore.primaryColor === c" name="check" class="color-check" />
                            </span>
                            <t-color-picker-panel style="margin-top: 10px;" :value="themeStore.primaryColor"
                    ...
                    <div class="setting-item">
                        ...
                        <t-slider :value="themeStore.borderRadius" :min="0" :max="40"
                    ...
                    <div class="setting-item">
                        ...
                        <t-switch :model-value="themeStore.onlyIcon"
                            @update:model-value="(val: boolean) => themeStore.setOnlyIcon(val as boolean)" />
                    </div>

                    <div class="setting-item">
                        <div class="setting-title">{{ t('组件尺寸') }}</div>
                        <t-radio-group :value="themeStore.componentSize"
                            @change="(val: any) => themeStore.setComponentSize(val as 'small' | 'medium' | 'large')">
                ...
                <div class="setting-panel bg-panel">
                    ...
                    <div class="setting-item">
                        ...
                        <div style="margin-top: 8px; position: relative;">
                            <img :src="themeStore.wallpaperUrl || ''"
                                style="width: 100%; height: 140px; object-fit: cover;" />
                            <t-button style="position: absolute; bottom: 10px; left: 10px;"
                                @click="showWallpaper = true">更换壁纸</t-button>
                            <t-button theme="danger" variant="outline"
                                style="position: absolute; bottom: 10px; right: 10px;"
                                @click="themeStore.setWallpaperUrl(null)">清除</t-button>
                        </div>
                    </div>
                    ...
                    <div class="setting-group">
                        ...
                        <div class="setting-item">
                            ...
                            <t-slider :value="themeStore.bgOpacity" :min="0" :max="1" :step="0.1"
                                :input-number-props="{ theme: 'column' }"
                        ...
                        <div class="setting-item">
                            ...
                            <t-slider :value="themeStore.containerOpacity" :min="0" :max="1" :step="0.1"
                                :input-number-props="{ theme: 'column' }"
                                @change="(val: any) => themeStore.setContainerOpacity(val as number)" />
                        </div>
                        <div class="setting-item">
                            <div class="setting-title">{{ t('背景模糊') }}</div>
                            <t-slider :value="themeStore.bgBlur" :min="0" :max="100" :step="1"
                                :input-number-props="{ theme: 'column' }"
                    ...
                    <div class="setting-group">
                        ...
                        <div>
                            <div class="setting-item">
                                ...
                                <t-switch :model-value="themeStore.sideTheme === 'dark'"
                            ...
                            <div class="setting-item">
                                ...
                                <t-slider :value="themeStore.sideWidth" :min="150" :max="800" :step="10"
                                    :input-number-props="{ theme: 'column' }"
                                    @change="(val: any) => themeStore.setSideWidth(val as number)" />
                            </div>
                            <div class="setting-item">
                                <div class="setting-title">{{ t('侧边栏背景透明度') }}</div>
                                <t-slider :value="themeStore.sideOpacity" :min="0" :max="1" :step="0.1"
                                    :input-number-props="{ theme: 'column' }"
                        ...
                        <div class="setting-item">
                            ...
                            <t-slider :value="themeStore.sideItemSelectOpacity" :min="0" :max="1" :step="0.1"
                                :input-number-props="{ theme: 'column' }"
                    ...
                    <div class="setting-group">
                        ...
                        <div class="setting-item">
                            ...
                            <t-switch :model-value="themeStore.modalWallpaperEnabled"
                        ...
                        <div>
                            <div class="setting-item">
                                ...
                                <t-slider :value="themeStore.modalOpacity" :min="0" :max="1" :step="0.1"
                                    :input-number-props="{ theme: 'column' }"
                            ...
                            <div class="setting-item">
                                ...
                                <t-slider :value="themeStore.modalBgBlur" :min="0" :max="100" :step="1"
                                    :input-number-props="{ theme: 'column' }"
        ...
        <div class="global-actions">
            <t-button theme="primary" variant="outline"
                @click="() => { themeStore.resetTheme(); themeStore.resetSidebar(); }">
                <template #icon><t-icon name="refresh" /></template>
                {{ t('重置') }}
            </t-button>
        </div>
        ...
        <div style="display: flex; gap: 16px;">
            ...
            <div style="flex: 1; min-width: 0;">
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px;">
                    <div v-for="img in wallpaperList" :key="img.url"
                ...
                <div style="margin-top: 12px; text-align: center;">
                    <t-button variant="text"
                        @click="start += pageCount; fetchWallpaperList(currWallpaperCat, false)">加载更多</t-button>
                </div>
            </div>
        </div>
    </t-dialog>
