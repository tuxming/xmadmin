    ...
    <div class="editable-tag-wrap" style="position: relative; padding-right: 30px">
        <template v-if="editing">
            <div style="display: flex; width: 100%; align-items: center; gap: 8px;">
                <t-input v-if="type === 'text'" v-model="localValue" @blur="onBlur" style="flex: 1; width: 100%;"
                    auto-focus />
                <t-input v-else v-model="localValue" type="password" @blur="onBlur" style="flex: 1; width: 100%;"
                    auto-focus />
