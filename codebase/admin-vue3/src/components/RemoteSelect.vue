<template>
    <t-select v-model="internalValue" :multiple="multiple" :filterable="true" :options="options" :loading="loading"
        :placeholder="placeholder" :reserve-keyword="props.reserveKeyword" @search="onSearch" @focus="onFocus"
