<template>
    <t-config-provider :global-config="globalConfig">
        ...
        <template v-for="(layer, key) in layerState" :key="key">
            <component v-if="layer.type === 'confirm'" :is="layer.component" v-bind="layer.props" @ok="layer.props.onOk"
                @cancel="layer.props.onCancel" @close="layer.props.onClose" />
            <component v-else-if="layer.type === 'modal'" :is="layer.component" v-bind="layer.props"
