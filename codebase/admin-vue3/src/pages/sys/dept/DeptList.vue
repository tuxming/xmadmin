<template>
    <div class="table-wrap" ref="tableWrapRef">
        <t-enhanced-table ref="tableRef" class="need-buttom-border" :data="data" :columns="tdColumns" row-key="id"
            :loading="loading" :pagination="pagination" :selected-row-keys="selectedRowKeys"
            v-model:expanded-tree-nodes="expandedTreeNodes" :height="tableHeight"
            :scroll="{ type: 'virtual', rowHeight: 48, bufferSize: 20 }" :tree="treeConfig" bordered
