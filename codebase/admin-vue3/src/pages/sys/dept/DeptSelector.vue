<template>
    <t-popup placement="bottom-left" trigger="click" :visible="popupVisible" @visible-change="onPopupVisibleChange">
        ...
        <template #content>
            <div class="tree-panel">
                <t-tree :data="treeData" :keys="fieldNames" :load="onLoadData" :expanded="expandedKeys"
                    @expand="onTreeExpand" hover activable @click="onTreeNodeClick" />
            </div>
        </template>
    </t-popup>
</template>
