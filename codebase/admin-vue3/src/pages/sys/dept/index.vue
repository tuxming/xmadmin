<template>
  <div class="dept-page">
    <div class="table-toolbar">
      <t-space wrap>
        <AuthButton theme="primary" :tip="t('新增组织')" :required-permissions="permission.dept?.create?.expression" @click="onCreate">
          <template #icon><t-icon name="add" /></template>
          {{ !onlyIcon ? t('新增') : '' }}
        </AuthButton>
        <AuthButton theme="default" :tip="t('编辑组织')" :required-permissions="permission.dept?.update?.expression" @click="onEdit">
          <template #icon><t-icon name="edit" /></template>
          {{ !onlyIcon ? t('编辑') : '' }}
        </AuthButton>
        <AuthButton theme="danger" :tip="t('删除组织')" :required-permissions="permission.dept?.delete?.expression" @click="onDelete">
