<template>
    <Modal :open="visible" :title="title" :width="600" :show-mask="false" @close="onModalClose">
        <div style="width: 100%">
            <div style="padding: 0px 20px 10px 20px; margin: 0px auto">
                ...
                <t-form ref="formRef" :data="formData" :rules="rules" @submit="onFinish">
                    ...
                    <t-form-item name="parentId" :label="t('上级组织')">
                        <DeptSelector v-model="formData.parentId" :path="formData.path"
                            :parent-name="formData.parentName" :return-object="true"
