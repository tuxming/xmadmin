<template>
    <Modal :open="visible" :title="t('分配菜单')" :width="400" @close="onCloseModal">
        <div style="padding: 0px 20px 10px 40px; min-height: 480px; overflow-y: auto;">
            ...
            <t-tree v-if="treeData && treeData.length > 0" :data="treeData" hover expand-all checkable
                :value="checkedKeys" :keys="{ label: 'title', value: 'key', children: 'children' }" @change="onCheck">
                <template #icon="{ node }">
