<template>
    <TableComponent :page-size="20" :query="query" :api-url="api.lang.resources" :width="width" :height="height"
        :on-select="onSelect" :columns="columns" :refresh="refresh" :init-load="false" />
</template>
